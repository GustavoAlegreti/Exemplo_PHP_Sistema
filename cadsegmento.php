 ...
 */
    ...
    $res = mysqli_query($con, "insert into segmento values (0, '$segmento')");

    echo mysqli_affected_rows($con)." registro(s) cadastrado(s) com sucesso!";
?>
</body>
    <a href="http://localhost/exemploale.php" style="font-family: verdana; color: #80FF00; text-decoration: none;"> Voltar</a>
</html>